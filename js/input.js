...
const TECLAS_DO_JOGO = ["w", "a", "s", "d", "arrowup", "arrowleft", "arrowdown", "arrowright", " ", "1", "2", "3"];
const textKeys = {};
...
canvas.addEventListener("mousedown", (e) => { canvas.focus(); if (e.button === 0) { atualizarMouse(e); mouse.isDown = true; if (gameState === "PLAYING" && player && player.hp > 0) { atualizarMiraJogador(); atirarJogador(Date.now()); } e.preventDefault(); } });
