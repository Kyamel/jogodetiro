...
let camX = 0, camY = 0; let safeZone = { radius: 1100 }; let frameScale = 1;
...
const ESTADO_CHEFE = { PATRULHA: "PATRULHA", PERSEGUICAO: "PERSEGUICAO", COMBATE: "COMBATE", RECUO: "RECUO", BUSCA: "BUSCA" };
