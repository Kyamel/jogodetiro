...
if (!inventario.skins) {
  inventario.skins = inventarioPadrao.skins;
  inventario.skinEquipada = 'padrao';
}
...
let passePadrao = {
  ...
  resgatadosVip: [],
  missoes: [
    {id: 0, desc: 'Jogar Partidas', meta: 3, atual: 0, premio: 50},
    {id: 1, desc: 'Eliminar Inimigos', meta: 10, atual: 0, premio: 50},
    {id: 2, desc: 'Causar Dano', meta: 1000, atual: 0, premio: 50},
    {id: 3, desc: 'Vencer Partidas (Top 5 / Derrotar Boss)', meta: 1, atual: 0, premio: 100}
  ]
};
...
function salvarProgresso() {
  localStorage.setItem('br_moedas', moedas);
  localStorage.setItem('br_diamantes', diamantes);
